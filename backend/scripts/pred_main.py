...
MODEL_PATH = os.getenv("MODEL_PATH", os.path.join(BASE_DIR, "backend\models\optimized_random_forest_model.pkl"))
SCALER_PATH = os.getenv("SCALER_PATH", os.path.join(BASE_DIR, "backend\models\random_forest_scaler.pkl"))
LAST_PREDICTION_PATH = os.path.join(BASE_DIR, "backend\models\last_prediction.json")  # you can keep it relative too if preferred
