...
MODEL_PATH = os.getenv("REV_MODEL_PATH", os.path.join(BASE_DIR, "backend\models\rev_optimized_random_forest_model.pkl"))
SCALER_PATH = os.getenv("REV_SCALER_PATH", os.path.join(BASE_DIR, "backend\models\rev_random_forest_scaler.pkl"))
