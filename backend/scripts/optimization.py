...
import json
# JSON file path
JSON_PATH = r'backend\models\last_prediction.json'
...
def load_model_and_scaler():
    model = joblib.load(r'backend\models\optimized_random_forest_model.pkl')
    scaler = joblib.load(r'backend\models\random_forest_scaler.pkl')
    return model, scaler
